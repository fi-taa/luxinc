  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 p-5 md:p-6">
        <h3 className="font-sans text-base font-semibold text-zulu-text md:text-lg">
          {item.title}
        </h3>
        <p className="mt-2 font-sans text-xs font-normal leading-relaxed text-zulu-text/85 md:text-sm">
          {item.subtitle}
        </p>
      </div>
    </Link>
