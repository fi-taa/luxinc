...
export function ContentDetailPage({
  ...
  return (
    <main className="relative min-h-screen bg-zulu-bg text-zulu-text">
      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto w-full max-w-[1280px] px-6 pb-16 pt-4 md:px-10 md:pb-20 md:pt-6 lg:px-16">
          <article className="mx-auto max-w-5xl">
            ...
            <p className="mt-8 text-center font-sans text-sm text-zulu-text/70 md:mt-10">
              {detail.date}
            </p>

            <h1 className="mx-auto mt-5 max-w-4xl text-center font-diphylleia text-[clamp(1.75rem,4.5vw,2.75rem)] font-normal leading-tight text-zulu-gold md:mt-6">
              {detail.title}
            </h1>
          ...
          {detail.related.length > 0 ? (
            ...
            >
              <h2
                id="related-heading"
                className="text-center font-diphylleia text-[clamp(2rem,5vw,2.5rem)] font-normal text-zulu-gold"
              >
                Related Contents
              </h2>
