...
export function CommitmentSection() {
  return (
    <SectionShell ariaLabelledBy="commitment-heading">
      <div className="flex flex-col items-center justify-center gap-10 lg:flex-row lg:items-center lg:gap-16 xl:gap-24">
        <p
        ...
        >
          ...
          <br />
          {commitment.line2}{" "}
          <span className="bg-gradient-to-r from-zulu-gold from-[55%] to-transparent px-2 py-0.5 text-zulu-bg">
