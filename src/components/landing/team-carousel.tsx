  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 p-4 md:p-5">
        <h3
          className={cn(
            "font-sans font-semibold text-zulu-text",
        ...
        <p
          className={cn(
            "mt-1.5 font-sans font-normal leading-relaxed text-zulu-text/90",
...
function CarouselNavButton({
  ...
  const label = direction === "prev" ? "Previous team member" : "Next team member";
  ...
  return (
    <button
      ...
      onClick={onClick}
      aria-label={label}
      className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-zulu-text/80 text-zulu-text transition-colors hover:border-zulu-text hover:bg-zulu-text/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zulu-gold focus-visible:ring-offset-2 focus-visible:ring-offset-zulu-bg md:h-11 md:w-11"
    >
