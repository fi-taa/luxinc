		...
		<footer>
			...
			<div className="bg-luxinc-panel px-6 py-10 text-center md:px-10 md:py-12 lg:px-16">
				<p className="font-diphylleia text-sm font-normal leading-relaxed text-luxinc-gold md:text-base">
					<span className="font-normal text-luxinc-gold">LUXINC</span>
					{" — "}
					{footer.tagline}
				</p>
				<p className="mt-3 font-diphylleia text-sm font-normal leading-relaxed text-luxinc-gold md:text-base">
					{footer.locations}
				</p>
				<p className="mt-3 font-diphylleia text-sm font-normal leading-relaxed text-luxinc-gold/90 md:text-base">
					{footer.copyright}
				</p>
			</div>
		</footer>
