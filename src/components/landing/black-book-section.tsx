      ...
      >
        <div className="mx-auto flex max-w-2xl flex-col items-center px-6 py-16 text-center md:py-20 lg:py-24">
          ...
          <h2
            ...
            className="mx-auto mt-6 w-max max-w-full font-edu-guides text-[50px] font-normal not-italic leading-none tracking-normal text-zulu-gold max-sm:mt-8 max-sm:text-[clamp(1.5rem,8vw,50px)] md:mt-8"
          >
            {blackBook.title}
          </h2>

          <p className="mt-4 max-w-md font-serif text-sm font-normal italic text-zulu-text md:mt-5 md:text-base">
            {blackBook.subtitle}
          </p>
