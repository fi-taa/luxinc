      ...
      {slides.map((slide, index) => {
        ...
        return (
          <button
            ...
            className={cn(
              "h-3 w-3 shrink-0 transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zulu-gold focus-visible:ring-offset-2 focus-visible:ring-offset-zulu-bg",
              isActive
                ? "bg-zulu-gold"
                : "border border-zulu-gold/60 bg-zulu-gold/25 hover:bg-zulu-gold/45"
            )}
          />
        );
      })}
        ...
        <div className="relative mt-2 min-h-[3.25rem] md:min-h-[3.5rem]">
          {slides.map((slide, index) => (
            <p
              ...
              className={cn(
                "font-sans text-xs leading-relaxed text-zulu-text-muted transition-opacity ease-in-out md:text-sm",
                index === activeIndex
                  ? "relative opacity-100"
