      ...
      <div className="relative flex flex-col lg:flex-row lg:items-stretch">
        <div className="flex min-w-0 flex-col lg:w-1/2 lg:shrink-0">
          ...
          <Link
            ...
            className="relative mt-8 block w-screen max-w-[100vw] transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zulu-gold focus-visible:ring-offset-2 focus-visible:ring-offset-zulu-bg max-lg:left-1/2 max-lg:-translate-x-1/2 lg:mt-10 lg:ml-[calc(100%-50vw)] lg:w-full lg:max-w-none"
          >
            <Image
        ...
        <div className="relative flex min-h-[400px] flex-col justify-center overflow-visible px-6 py-10 md:px-10 lg:w-1/2 lg:shrink-0 lg:py-0 lg:pl-8 lg:pr-10 xl:pl-10 xl:pr-12">
          ...
          <div className="relative z-10 w-full max-w-2xl space-y-8 lg:max-w-none lg:space-y-10">
            <Link
              ...
              className="block transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zulu-gold focus-visible:ring-offset-2 focus-visible:ring-offset-zulu-bg"
            >
